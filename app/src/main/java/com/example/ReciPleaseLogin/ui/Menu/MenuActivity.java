...
public class MenuActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        DB.getInstance().saveRecipeToDatabase(new IUpdatable() {
            @Override
            public void onUpdateSuccess() {
                Log.i("Login Activity", "Saving Successful!");
            }

            @Override
            public void onUpdateFailure() {
                Log.i("Login Activity", "Saving Failed");
            }
        });

        String name = "SteakExample";
        //test retrieving functionality
        DB.getInstance().pullRecipe(new IRecipeListener() {
            @Override
            public void onRetrievalSuccess(RecipeExample recipe) {
                test.setText(recipe.getName());
            }
